...
import com.androidapp.convero.adapters.IngredientAdapter;
...
public class IngredientSpinner extends AppCompatSpinner {
    ...
    public void setIngredients(List<Ingredient> ingredients) {
        ...
        SpinnerAdapter spinnerAdapter = new ArrayAdapter<>(getPopupContext(), R.layout.spinner_item, ingredients);
