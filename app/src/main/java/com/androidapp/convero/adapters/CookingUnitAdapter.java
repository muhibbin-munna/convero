...
public class CookingUnitAdapter extends BaseAdapter {
    private final LayoutInflater inflater;
    private final List<Unit<? extends Quantity>> units;

    public CookingUnitAdapter(@NonNull Context context, List<Unit<? extends Quantity>> units) {
        super();
    ...
    private View constructView(int position, @Nullable View convertView, @NonNull ViewGroup parent, @LayoutRes int resource) {
        ...
        view.setText(CookingUnits.unitToString(unit));
